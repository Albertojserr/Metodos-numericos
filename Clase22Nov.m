clear
clf
x0=-0.2+rand(50,1)*0.4;%esto hay que subirlo
Px0=-0.2+rand(50,1)*0.4;
a=15;
while a>=6
    clf
    h=1/a;
...
function[]=HenonHelles(x0,px0,h)
    ...
    for i=4:1:d-1
        ...
        if ye2(i+1)*ye2(i)<=0
            if pye2(i+1)>0
            AuxX(r)=-(xe2(i+1)-xe2(i))*ye2(i)/(ye2(i+1)-ye2(i))+xe2(i);
            AuxPx(r)=-(pxe2(i+1)-pxe2(i))*ye2(i)/(ye2(i+1)-ye2(i))+pxe2(i);
            r=r+1;
            end
        end
    end
    hold on
    plot(AuxX,AuxPx,'r.','MarkerSize',4)
